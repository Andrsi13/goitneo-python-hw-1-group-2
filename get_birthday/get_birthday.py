...
a = [
    {"name": "Bill Gates", "birthday": datetime(1967, 2, 26)},
    {"name": "Papa Johnes", "birthday": datetime(1995, 3, 1)},
    {"name": "Bill Johnes", "birthday": datetime(1995, 3, 3)},
]  # список словників для тестування
